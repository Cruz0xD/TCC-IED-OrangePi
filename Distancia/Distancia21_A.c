...
// Convencional: gcc -Wall -Iincludes_libiec61850 -Llibiec61850-1.5.1/build Distancia/Distancia21_A.c Distancia/goose_pub.c Distancia/fft.c Distancia/phasor.c Distancia/mergingUnit.c -liec61850 -o IED_A -lm -lpthread
// Orange Pi: gcc -Wall -Iincludes_libiec61850 -Llibiec61850-1.5.1/build Distancia/Distancia21_A.c Distancia/goose_pub.c Distancia/fft.c Distancia/phasor.c Distancia/mergingUnit.c -liec61850 -o IED_A -lm -lpthread -lwiringPi
...
int main() {
    ...
    */
    ...
    FILE *fp = fopen("dados_intervalos.txt", "w");
    if (fp == NULL) {
